...
def riesgoControl_menu():
    response.menu += [
        (T('Risks & Controls'), False, '#', [
            (T('Risk Analysis'), False, URL('default', 'AnalisisRiesgo')),
            LI(_class="divider"),
            (T('Risk Factor'), False, URL('default', 'TratamientoRiesgo')),
            (T('Risk Factor Evidence'), False, URL('default', 'FactorEvidencia')),
            (T('Risk Factor CVSS'), False, URL('default', 'ValorMetricaSeguridadTi')),
            LI(_class="divider"),
            (T('Risk & Risk Classification'), False, URL('default', 'AnalisisRiesgoClasificacionRiesgo')),
            (T('Risk & Organisational Objective'), False, URL('default', 'AnalisisRiesgoObjetivoOrganizacion')),
            (T('Risk & Risk Factor'), False, URL('default', 'TratamientoRiesgoAnalisisRiesgo')),
        ]),
    ]
